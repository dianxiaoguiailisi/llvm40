...
bool CollectLoopHints::instrumentLoopHeader(Instruction *I, int fid, int level, int count) {
    ...
    errs() << __func__ << " : "<< *I<< "\n";
        ...
        llvm::FunctionCallee ConstCollectLoopHints = M->getOrInsertFunction(
        "__collect_loop_hints", 
        VoidTy, 
        I32Ty, 
        I32Ty, 
        I32Ty, 
    ...
    llvm::Function *FuncCollectLoopHints = llvm::cast<llvm::Function>(ConstCollectLoopHints.getCallee());
